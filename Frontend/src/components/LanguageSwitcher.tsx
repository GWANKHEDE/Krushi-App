    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="h-8 md:h-9 px-2 md:px-3 text-xs md:text-sm font-bold uppercase tracking-widest gap-2 bg-background/50 backdrop-blur-sm border border-primary/10 rounded-xl hover:bg-primary/5 transition-all">
